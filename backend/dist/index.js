...
import { startScheduledBackups, stopScheduledBackups, } from "./services/backup.js";
import { startMonitor as startPinMonitor, stopMonitor as stopPinMonitor, } from "./services/ipfs-monitor.js";
import { server, getPendingSequenceLockOps, waitForSequenceLockIdle, } from "./services/stellar.js";
import { startConfirmationWorker, stopConfirmationWorker, } from "./services/confirmation-queue.js";
import { attachConfirmationHub, closeConfirmationHub, } from "./services/confirmation-hub.js";
...
async function startBackgroundServices() {
    ...
    if (config.indexerEnabled) {
        ...
        try {
            ...
            services.stellar.server, contractIds, config.indexerPollIntervalMs);
 ...
 */
function registerSupervisorServices() {
