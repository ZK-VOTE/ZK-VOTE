 ...
 */
export function getLogMetrics(reset = false) {
 ...
 */
function shouldSample(path, statusCode, durationMs) {
...
export function requestLogger(req, res, next) {
    ...
    res.on("finish", () => {
        ...
        if (isError)
            logMetrics.errorLogged++;
        if (isSlow)
            logMetrics.slowLogged++;
 ...
 */
export function logMetricsEndpoint(_req, res, _next) {
    res.json({
