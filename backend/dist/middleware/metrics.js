 ...
 * queueing.
 */
import { httpRequestsTotal, httpRequestDuration, httpRequestSize, httpRequestsInFlight, httpResponseSize, } from "../services/metrics.js";
...
export function metricsMiddleware(req, res, next) {
    ...
    res.end = function (...args) {
        ...
        const route = normalizeRoute(typeof req.route?.path === "string" ? req.route.path : req.path);
