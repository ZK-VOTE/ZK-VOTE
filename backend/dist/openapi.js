...
import { z } from "zod";
import { voteSchema, anonymousCommentSchema, editCommentSchema, deleteCommentSchema, flagCommentSchema, manualEventSchema, notifyEventSchema, bridgeVoteSchema, } from "./validation/schemas.js";
...
function idParam(example, description) {
...
export function buildOpenApiDocument() {
    ...
    registry.registerComponent("securitySchemes", SECURITY_SCHEME, {
        ...
        in: "header",
        name: "X-Relayer-Auth",
        description: "Shared relayer auth token (also accepted as `Authorization: Bearer <token>`). " +
    ...
    return generator.generateDocument({
        ...
        info: {
            ...
            version: "1.0.0",
            description: "Backend relayer for anonymous voting on Stellar/Soroban. Generated from route " +
