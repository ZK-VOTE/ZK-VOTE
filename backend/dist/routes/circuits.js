...
router.get("/circuits/vk/:circuitId/:version", queryLimiter, (async (req, res) => {
...
router.get("/circuits/vk/:circuitId", queryLimiter, (async (req, res) => {
