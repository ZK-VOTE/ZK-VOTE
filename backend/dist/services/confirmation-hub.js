 ...
 */
export function attachConfirmationHub(httpServer) {
    if (attachFailed || !config.confirmationWsEnabled)
        return;
    if (wss)
        return;
    try {
 ...
 */
export function broadcastConfirmationEvent(payload) {
    if (!wss)
        return;
...
//# sourceMappingURL=confirmation-hub.js.map