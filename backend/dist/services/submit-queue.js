...
export class BoundedSubmitQueue {
     ...
     */
    async enqueue(execute, timeoutMs) {
        ...
        try {
            while (this.queue.length > 0 && !this.shutdownRequested) {
                ...
                try {
                    ...
                    const result = await this.executeWithTimeout(submission.execute, remainingTimeoutMs, submission.abortController.signal);
...
//# sourceMappingURL=submit-queue.js.map