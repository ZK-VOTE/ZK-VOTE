...
//
// Merkle depth 25: supports up to 2^25 = 33,554,432 members.
//
// Identical to vote.circom except for the tree depth. Proving cost is dominated
// by the 25 Poseidon hashes of the Merkle path, so a smaller depth means a
...
component main {public [root, nullifier, daoId, proposalId, voteChoice, numCandidates, relayerAddress]} = Vote(25);
