...
export const BIP39_WORDLIST: string[] = [
  ...
  "baggage", "bake", "balance", "balcony", "ball", "bamboo", "banana", "banner", "bar", "barely",
  ...
  "dragon", "drama", "drastic", "draw", "dream", "dredge", "drift", "drill", "drink", "drip",
  ...
  "index", "indicate", "indoor", "industry", "infant", "inflict", "inform", "inquire", "inside", "inspire",
  ...
  "melon", "melt", "member", "memory", "mention", "menu", "mercy", "merge", "merit", "merry",
  ...
  "tattoo", "tiger", "timber", "time", "tiny", "tip", "tired", "tissue", "title", "toast",
...
export function entropyToMnemonic(entropy: Uint8Array): string {
  if (entropy.length !== 16 && entropy.length !== 32) {
    throw new Error("Entropy length must be 16 bytes (12 words) or 32 bytes (24 words)");
  }
...
export function masterSecretToMnemonic(masterSecret: bigint | string): string {
  const bn = typeof masterSecret === "string" ? BigInt(masterSecret) : masterSecret;
